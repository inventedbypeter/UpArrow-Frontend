...
export async function getServerSideProps() {
    const response = await fetch("http://localhost:4000/api/v1/investor/fetch/all/user/comments/6232b9db69c746d0e7f01700");
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        const stockResponse = await fetch(`http://localhost:4000/api/v1/investor/fetch/stock/${stockId}`);
